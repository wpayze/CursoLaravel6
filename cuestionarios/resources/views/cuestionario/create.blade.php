                ...
                <div class="card-body">
                    <form action="{{route('cuestionarios.store')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="titulo" value="{{old("titulo")}}" class="form-control" id="titulo" aria-describedby="tituloHelp" placeholder="T&iacute;tulo del cuestionario">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="descripcion" value="{{old("descripcion")}}" class="form-control" id="descripcion" aria-describedby="descripcionHelp" placeholder="Descripci&oacute;n del cuestionario">
